  ...
  return (
    <nav className="flex-div">
      <div className="nav-left flex-div">
        <img src={menu_icon} alt="menu_icon" onClick={()=>setsidebar(prev => prev === false?true:false)} className='menu-icon' />
        <Link to='/'><img src={logo} alt="logo" className='logos flex-logo' /></Link>
      </div>
